<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="cat_Default" %>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>CAT-CIRCUTAL APTITUDE TEST</title>
...
<body>
	...
	<section id="page-top" class="section-style" data-background-image="images/background/page-top.jpg">
		<div class="pattern height-resize">
			<div class="container">
               ...
               <h1><a href="catstart.aspx" >CLICK HERE TO PRACTICE</a></h1>

                <h1><a href="index.html">CLICK HERE FOR CAT SECTION</a></h1>
		...
		<div class="pattern height-resize"> 
			<div class="container">
				...
				<p class="section-description">
				 We are programmers who specializes in, or is specifically engaged in, the development of World Wide Web applications, or distributed network applications that are run over HTTP from a web server to a web browser.
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="team-member">
								<figure>
									<img src="images/team/team-member-1.jpg" alt="Team Member" style="width:300px;height:220px;">
									<figcaption>
										<p class="member-name">Akshat Chitransh</p>
										<p class="designation">
								             WEB DEVELOPER
										</p><!-- /.designation -->
						...
						<div class="col-sm-4">
							<div class="team-member">
								<figure>
									<img src="images/team/team-member-2.jpg" alt="Team Member" style="width:300px;height:220px;">
									<figcaption>
										<p class="member-name">
											SNEH SAJAL
										</p><!-- /.member-name -->
						...
						<div class="col-sm-4">
							<div class="team-member">
								<figure>
									<img src="images/team/team-member-3.jpg" alt="Team Member" style="width:320px; height:220px;">
									<figcaption>
										<p class="member-name">
											AKASH RANJAN
										</p><!-- /.member-name -->
	...
	<section id="subscribe" class="section-style" data-background-image="images/background/newsletter.jpg">
		...
		<footer id="footer-section">
			<p class="copyright">
				&copy; <a href="index.aspx">IETE BIT MESRA</a> 2016-2034, All Rights Reserved. Developed by <a href="https://www.facebook.com/sneh.sajal">SNEH SAJAL</a> &  <a href="https://www.facebook.com/akshat.chitransh">AKSHAT CHITRANSH</a> and  Designed by<a href="https://www.facebook.com/akash.ranjan.9883"> AKASH RANJAN</a>
			</p>
		</footer>
		<!-- Footer Section End -->
